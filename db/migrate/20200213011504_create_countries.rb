class CreateCountries < ActiveRecord::Migration[5.1]
  def change
    ...
    Country.create :iso => "AX", :name => "Åland"
    Country.create :iso => "AZ", :name => "Azerbaijan"
    Country.create :iso => "BA", :name => "Bosnia-Herzegovina"
    ...
    Country.create :iso => "BQ", :name => "Bonaire, St Eustatius & Saba"
    ...
    Country.create :iso => "C-", :name => "Clipperton Island"
    Country.create :iso => "CA", :name => "Canada"
    Country.create :iso => "CC", :name => "Cocos (Keeling) Islands"
    Country.create :iso => "CD", :name => "Congo D.R."
    Country.create :iso => "CF", :name => "Central African Rep."
    Country.create :iso => "CG", :name => "Congo"
    Country.create :iso => "CH", :name => "Switzerland"
    Country.create :iso => "CI", :name => "Côte d'Ivoire"
    ...
    Country.create :iso => "GS", :name => "South Georgia & Sandwich"
    ...
    Country.create :iso => "HM", :name => "Heard & McDonald Islands"
    ...
    Country.create :iso => "IO", :name => "British Indian Ocean Terr."
    ...
    Country.create :iso => "MM", :name => "Burma"
    Country.create :iso => "MN", :name => "Mongolia"
    Country.create :iso => "MO", :name => "Macau"
    ...
    Country.create :iso => "P-", :name => "Paracel Islands"
    ...
    Country.create :iso => "PM", :name => "Saint Pierre & Miquelon"
    Country.create :iso => "PN", :name => "Pitcairn Islands"
    Country.create :iso => "PR", :name => "Puerto Rico"
    Country.create :iso => "PS", :name => "Gaza Strip"
    ...
    Country.create :iso => "RE", :name => "Réunion"
    ...
    Country.create :iso => "S-", :name => "Spratly Islands"
    ...
    Country.create :iso => "TL", :name => "Timor-Leste"
    ...
    Country.create :iso => "UM", :name => "Minor Outlying Islands"
    ...
    Country.create :iso => "VC", :name => "St Vincent & the Grenadines"
    Country.create :iso => "VE", :name => "Venezuela"
    Country.create :iso => "VG", :name => "British Virgin Islands"
    Country.create :iso => "VI", :name => "Virgin Islands"
