...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"libs/select2.gmap.js":[function(require,module,exports) {
$ = window.$;
  ...
  GoogleAutocompleteDataAdapter.prototype.query = function (params, callback) {
    var returnSuggestions = function returnSuggestions(predictions, status) {
      ...
      for (var i = 0; i < predictions.length; i++) {
        data.results.push({
          id: JSON.stringify(predictions[i]),
...
var autocompleteAddress = function autocompleteAddress(fieldSelector) {
  $(fieldSelector !== null && fieldSelector !== void 0 ? fieldSelector : '.address-autocomplete').select2({
    width: '100%',
...
require('./libs/select2.gmap');

if (module.hot) {
  module.hot.accept();
}
},{"./libs/select2.gmap":"libs/select2.gmap.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
