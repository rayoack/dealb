...
Devise.setup do |config|
  ...
  config.mailer_sender = 'contact@dealbook.co'

  # Configure the class responsible to send e-mails.
  config.mailer = 'Devise::UsersMailer'
  ...
  # ==> Configuration for :lockable Defines which strategy will be
  # used to lock an account.  :failed_attempts = Locks an account
  # after a number of failed attempts to sign in.  :none = No lock
  # strategy. You should handle locking by yourself.
  #
  ...
  # Defines which strategy will be used to unlock an account.  :email
  # = Sends an unlock link to the user email :time = Re-enables login
  # after a certain amount of time (see :unlock_in below) :both =
  # Enables both strategies :none = No unlock strategy. You should
  # handle unlocking by yourself.
  #
  ...
  # 10, and copy REST_AUTH_SITE_KEY to pepper).
  #
  ...
  # first check for "users/sessions/new". It's turned off by default
  ...
  # Devise, or change the failure app, you can configure them inside
  ...
  # this engine is mountable, there are some extra configurations to
  # be taken into account.  The following options are available,
